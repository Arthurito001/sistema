...
class Pruebas(models.Model):
    id_estudio = models.CharField(max_length=11, blank=True, null=True)
    prueba = models.CharField(max_length=255, blank=True, null=True)
    entrega = models.CharField(max_length=15, blank=True, null=True)
    estudios_extras = models.CharField(max_length=255, blank=True, null=True)
    muestra = models.CharField(max_length=255, blank=True, null=True)
    metodo = models.CharField(max_length=255, blank=True, null=True)
    observacion = models.CharField(max_length=255, blank=True, null=True)
    costo = models.IntegerField(blank=True, null=True)
    tipo_e = models.CharField(max_length=15, blank=True, null=True)
...
class Registro(models.Model):
    ...
    doctor = models.CharField(blank=True, null=True)
...
class RegistroPacientePruebasmodel(models.Model):
    id = models.BigAutoField(primary_key=True)
...
class RegistroPacienteRegistro(models.Model):
    id = models.BigAutoField(primary_key=True)
...
class RegistroPacienteRegistrodosmodel(models.Model):
    id = models.BigAutoField(primary_key=True)
    nombre = models.CharField(max_length=200)
